            ...
            <section className="flex flex-col items-center justify-center my-5">
                ...
                <form className="w-full max-w-2xl">
                    ...
                    <div className="mt-5 grid grid-cols-1">
                        ...
                        <div className="mt-2 flex justify-center rounded-lg border border-dashed border-gray-900/25 px-6 py-10 h-40 w-80">
                            <div className="text-center">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6 text-gray-500 mx-auto">
